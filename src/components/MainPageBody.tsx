...
import listAdd from '../images/list_add.svg'
import listEdit from '../images/list_edit.svg'
import listRemove from '../images/list_remove.svg'
import '../styles/MainPageBody.less'
